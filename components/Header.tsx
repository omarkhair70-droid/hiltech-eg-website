        ...
        <div id="mobile-nav" className="border-t border-slate-200 bg-white md:hidden">
          <div className="container py-3">
            <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
              ...
              <Link href="/rfq" className="mt-2 inline-flex w-full justify-center rounded-md bg-orange-500 px-5 py-2.5 font-semibold text-white hover:bg-orange-600" onClick={() => setOpen(false)}>Start RFQ</Link>
            </div>
          </div>
        </div>
      ) : null}
