    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/90 bg-white/95 shadow-[0_4px_14px_rgba(15,23,42,0.05)] backdrop-blur-md">
      <div className="container flex h-14 items-center justify-between gap-3 md:h-16 md:gap-4">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Link href="/rfq" className="inline-flex items-center rounded-md bg-orange-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-orange-600">Request Project Quote</Link>
        </div>
              ...
              <div className="space-y-5">
                ...
                <section>
                  ...
                  <div className="mt-2 grid gap-2">
                    <Link href="/rfq" className="inline-flex w-full justify-center rounded-md bg-orange-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-orange-600" onClick={() => setOpen(false)}>Request Project Quote</Link>
