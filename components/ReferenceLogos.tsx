...
export async function ReferenceLogosSection() {
  ...
  return <SectionShell compact><section className="rounded-2xl border border-slate-200 bg-slate-50 p-5 md:p-6"><SectionHeader eyebrow="Social Proof" title="Partners &amp; Client References" description="Selected brand, partner, and client references from HILTECH project and supply materials." /><div className="mt-6 space-y-5"><LogoGroup title="Technology / Partner References" logos={partners} /><LogoGroup title="Client References" logos={clients} /></div><p className="mt-5 text-xs text-slate-500">Brand and client references are shown for context and do not imply formal partnership unless explicitly stated.</p></section></SectionShell>;
}
