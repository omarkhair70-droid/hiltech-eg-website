    ...
    <main dir="rtl">
      <SectionShell>
        <section className="rounded-3xl border border-slate-200 bg-white p-6 md:p-9">
          ...
          <h1 className="mt-3 text-3xl font-bold text-slate-900 md:text-5xl">تنفيذ ميداني حقيقي عبر الراك والكابلات والفايبر والاختبار</h1>
          <p className="mt-4 max-w-3xl text-slate-700">{arWorkContent.supporting}</p>
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link href="/ar/contact" className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100">تواصل مع HILTECH</Link>
          </div>
        </section>
          ...
          {arWorkContent.cards.map((card) => (
            <article key={card.title} className="public-card overflow-hidden rounded-2xl bg-white p-0">
              ...
              <div className="p-4">
                ...
                <p className="mt-2 text-sm text-slate-700"><span className="font-semibold text-slate-900">النطاق:</span> {card.scope}</p>
                <p className="mt-2 text-sm text-slate-700"><span className="font-semibold text-slate-900">مؤشر الثقة:</span> {card.confidence}</p>
              </div>
            </article>
          ))}
        </section>
        ...
        <section className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-6 md:p-8">
          <h2 className="text-2xl font-bold text-slate-900">أعمال ميدانية قابلة للتسليم والصيانة</h2>
          <p className="mt-3 max-w-3xl text-slate-700">تركز HILTECH على تنظيم الكابلات، وضوح المسارات، تجهيز الراك بشكل عملي، وتجهيز البنية للاختبار والتشغيل بعد التسليم.</p>
          <ul className="mt-5 grid gap-2 text-sm text-slate-700 sm:grid-cols-2">
            <li className="rounded-lg border border-slate-200 bg-white px-3 py-2">مسارات منظمة</li>
            <li className="rounded-lg border border-slate-200 bg-white px-3 py-2">كابلات قابلة للصيانة</li>
            <li className="rounded-lg border border-slate-200 bg-white px-3 py-2">تسليم جاهز للاختبار</li>
            <li className="rounded-lg border border-slate-200 bg-white px-3 py-2">تجهيز عملي للراك</li>
          </ul>
        </section>
      </SectionShell>
    </main>
