...
export default function ProductsClient({ initialProducts = staticProducts }: { initialProducts?: ProductItem[] }) {
  ...
  const filteredProducts = useMemo(() => (activeCategory === 'All' ? initialProducts : initialProducts.filter((item) => item.category === activeCategory)), [activeCategory, initialProducts]);
