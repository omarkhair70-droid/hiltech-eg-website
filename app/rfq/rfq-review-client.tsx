    ...
    <div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <aside className="space-y-4">
          ...
          {submitState.status === 'success' ? <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-900"><p>Request received successfully. RFQ reference: {submitState.requestCode}</p><p className="mt-1 text-emerald-800">Your RFQ reference is ready for tracking. Save this reference code to check status later.</p></div> : null}
