# Real Assets Needed for Public Launch
...
| `/logo.png`, `/favicon.png`, `/og-image.png` | Global brand and SEO assets | Final approved logo/favicon/OG image set | P1 | Replace only after brand approval for production. |

## Required Real Photos

- 6 real field photos
- 2 rack/data room photos
...
- `real-field-fiber-01.jpg`
- `real-rack-room-01.jpg`
- `real-testing-otdr-01.jpg`
- `real-team-site-visit-01.jpg`
- `hiltech-company-profile.pdf`

## Approval Rule

No image should be described as a real project photo until approved by HILTECH for public website use.
